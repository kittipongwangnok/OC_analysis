...
DP_Leo_t0 = open("oc_linear_dpleo_Kittipong_2021.in",'r').readlines()
...
T_obs_err = []
#Please change the input file
for line in open("oc_linear_dpleo_Kittipong_2021.in"):
...
rerults = OC_linear
f = open("oc_linear_dpleo_Kittipong_2021.out", 'w')
...
#Plot O-C vs BJD
InputFileInput  = "oc_linear_dpleo_Kittipong_2021.out"
