...
DP_Leo_t0 = open("oc_linear_dpleo_Beuermann_2011.in",'r').readlines()
...
T_obs_err = []
#Please change the input file
for line in open("oc_linear_dpleo_Beuermann_2011.in"):
...
rerults = OC_linear
f = open("oc_linear_dpleo_Beuermann_2011.out", 'w')
...
#Plot O-C vs BJD
InputFileInput  = "oc_linear_dpleo_Beuermann_2011.out"
